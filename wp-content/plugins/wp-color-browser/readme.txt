...
Author URI: http://www.crios.me
Plugin URI: https://github.com/CarlosRios/wp-color-browser
Tags: color browser, color chrome, chrome, google chrome, google chrome tabs
...
[https://github.com/CarlosRios/wp-color-browser](https://github.com/CarlosRios/wp-color-browser)  
...
3. Select `wp-color-browser.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

= Using FTP =

1. Extract the `wp-color-browser.zip` file to your computer
2. Upload the `wp-color-browser` directory to the `/wp-content/plugins/` directory
...
2. Frontend with WP Color Browser configured
