...
class CJTBlocksModel {
	...
	*/
	public function delete($ids)
    {
        ...
        do_action(CJTPluggableHelper::ACTION_DELETE_BLOCKS, $ids, $blocks, $pins);
	...
	*/
	public function getInfo($id) {
		...
		// Set shortcode name.
		$info->shortcode = "[" . CJTBlocksCouplingController::SHORTCODE_NAME . " name='{$info->name}']";
		return $info;
	}
	...
	*/
	public function getOrder() {
		return get_option('meta-box-order_ecm');
	}
	...
	*/
    ...
    {
		$orderOptionName = 'meta-box-order_ecm';
