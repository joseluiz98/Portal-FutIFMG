...
class CJTBlocksAjaxController extends CJTAjaxController {
    ...
    */
    public function createBlockAction($blockId = null, $blockType = null, $pinPoint = null, $viewName = null)
    {
        ...
        $blockData = apply_filters(CJTPluggableHelper::FILTER_BLOCK_NEW_PRE_SAVE_ACTION, $blockData);
    ...
    */
    public function reinstallAction()
    {
        ...
        do_action(CJTPluggableHelper::ACTION_REINSTALL);
    ...
    public function saveBlocksAction() 
    {
        ...
        if ( is_array( $blocksToSave ) && ! empty( $blocksToSave ) ) 
        {
            ...
            foreach ( $blocksToSave as $id => $postedblockPartialData ) 
            {
                ...
                // Pin Point clauyclated action
                do_action(CJTPluggableHelper::ACTION_CONTROLLER_SAVE_BLOCK_PIN_POINT_CALCULATED, $id, $blockData);
    ...
    */
    public function uninstallAction()
    {
        ...
        $uninstaller = CJTModel::getInstance('uninstall');

        try
        {

            $uninstaller->expressUninstall(); 

            do_action(CJTPluggableHelper::ACTION_UNINSTALL);
