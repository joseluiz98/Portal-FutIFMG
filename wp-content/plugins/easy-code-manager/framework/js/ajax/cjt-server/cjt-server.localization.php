...
(
	...
	'confirmSubmitErrorForm' => cssJSToolbox::__( "Unhandled error has been detected while processing the background request.
	...
	'confirmCloseErrorForm' => cssJSToolbox::__( "Its highly recomended to send us the error details so we can enahce CJT products.
