...
var CJTToolBoxNS = new (function ($) {
	...
	*/
	this.ButtonBase = function() {
        ...
        * 
        */
        this.flash = function(enable, onePulse)
        {
            
            if (enable === true)
            {
                
                // If OnePulse == true then add the class but wiothout flashing (no time intervals)
                if ((onePulse !== undefined) && (onePulse))
                {
                    if (!this.jButton.hasClass(this.toolbox.params.buttonFlashingClass))
                    {
                        this.jButton.find('button').addClass(this.toolbox.params.buttonFlashingClass);    
                    }
                }
                else if (!this.flashTimer)
                {
                    
                    this.flashTimer = setInterval($.proxy(
                    
                        function()
                        {
                            
                            this.jButton.find('button').toggleClass(this.toolbox.params.buttonFlashingClass);
            ...
            else
            {
                ...
                this.jButton.find('button').removeClass(this.toolbox.params.buttonFlashingClass);
					...
					var CJTToolBox = {
						...
						*/
						params : {
                            ...
                            buttonFlashingClass : 'cjt-toolbox-button-flash',
						},
