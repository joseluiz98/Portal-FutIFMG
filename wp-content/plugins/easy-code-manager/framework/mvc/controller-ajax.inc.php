...
abstract class CJTAjaxController extends CJTController 
{
	...
	*/
	public function _doAction() 
    {
		...
		if (!$authorized || !call_user_func_array('current_user_can', $this->defaultCapability)) {
			...
			$method = $this->ongetactionname(str_replace($this->getActionPrefix(), '', $action));
    ...
    */
    public function getActionPrefix()
    {
        ...
        $actionPrefix = "wp_ajax_" . CJTPlugin::PLUGIN_REQUEST_ID . '_';
	...
	*/
	protected function registryAction($action, $priority = 10, $paramsCount = 1, $prefix = null) 
    {
