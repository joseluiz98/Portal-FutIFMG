...
abstract class CJTController extends CJTHookableClass {
    ...
    */
    public function __construct($hasView = null, 
        ...
        $this->overridePath = dirname($overrideControllerPath);
        $this->overridePrefix = $overrideContollerPrefix;
        ...
        if ($hasView === null) { // Default value for $hasView = true
            ...
            $view = $this->ongetviewname(
                isset($this->request['view']) ?
                $this->request['view'] :
    ...
    */
    protected function displayAction()
    {
        ...
        $layout =   isset($this->request['layout']) ?
                    $this->request['layout'] : 
                    'default';
