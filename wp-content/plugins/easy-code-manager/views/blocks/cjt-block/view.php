...
class CJTBlocksCjtBlockView extends CJTView {
    ...
    * @var mixed
    */
    private static $panelsListHooked = false;
	...
	*/
	public function __construct($viewInfo) 
    {
        ...
        // Hook into panel only once
        if (!self::$panelsListHooked)
        {
            // Add panel item for assignment panel 
            add_action(CJTPluggableHelper::ACTION_BLOCK_PANEL_FIRST, array($this, '_panelItem'));
            
            self::$panelsListHooked = true;
        }
	}
    ...
    * 
    */
    public function _panelItem()
    {
        require 'tmpl' . DIRECTORY_SEPARATOR . 'panel-item.html.php';
    }
